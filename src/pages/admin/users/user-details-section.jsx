...
import { formatNumber, isEmpty } from "../../../helpers/function";
          ...
          <div className="bg-[#F6F4FD] p-4 pt-6 flex justify-between items-center rounded-t-lg border-b">
            <div className="flex gap-2 items-center">
              ...
              <div className="text-xs">
                <p className="text-[#3514FF] font-bold">{accountName}</p>
          ...
          <div className="p-4 border-b">
            <div className="flex justify-between mb-4 gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs font-bold">{userDetails?.email}</p>
              </div>
              <div className="flex-1">
              ...
              <div className="border p-3 px-4 rounded-md border-[#3514FF]">
                ...
                <div>
                  ...
                  <span className="text-lg text-[#3514FF] font-bold">
                    {formatNumber(userDetails?.walletAmount, 2)}
                  </span>
                </div>
              </div>
            </div>
            ...
            {userDetails.userExperiences.length > 0 ? (
              userDetails.userExperiences.map((exp) => (
                <>
                  ...
                  <div className="text-tiny">
                    23+ years of experience in the aerospace engineering domain
                    with extensive expertise in the industry, start-up
                    consultant, and educational consultant. Responsibilities -
                    Customer interface, project management, delivery management,
                    program management, sales and pre-sales support,
                    campaigning, competency development, team building, making
                    competitive proposals, mentoring, and consultant
                  </div>
                </>
              ))
            ) : (
