	...
	return (
		<div className="p-4 max-w-2xl mx-auto">
			...
			<div>
				...
				{
					<div className="max-w-sm mx-auto">
						<BaseButton variant="sec">Cancel Gig</BaseButton>
					</div>
				}
				{
					<div className="max-w-sm mx-auto">
...
/*
	{steps.map((step, index) => (
					<li key={index} className="mb-10 ms-6">
						...
						<div>
							This is the content part sha Lorem ipsum dolor sit amet
							consectetur adipisicing elit. Saepe odio, dolorum atque minus
							nihil vitae dolorem quo quis velit amet error nemo fuga tenetur
							cumque veniam molestias. Sed, non ducimus iste reprehenderit
							inventore deleniti deserunt saepe officia nemo, amet repellat
							quasi et dignissimos sunt? Accusantium saepe sequi odio nam quidem
							architecto eveniet molestiae, voluptates, placeat dignissimos
							tempora eos consequatur nobis mollitia magni suscipit at?
							Exercitationem, quisquam reiciendis iusto vitae repellendus
							suscipit laboriosam maxime cumque possimus. Dolores, ea earum
							dolor temporibus doloremque nobis? Nam ducimus accusantium at est
							rerum, magnam perspiciatis neque aut? Sunt rerum exercitationem,
							consequatur harum asperiores aut est?{" "}
						</div>
					</li>
				))}
*/
