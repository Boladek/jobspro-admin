...
export function BusinessIndustry({ open, handleClose }) {
	const {
		register,
		formState: { errors },
		handleSubmit,
		...
		<Modal open={open} handleClose={handleClose} maxWidth={400}>
			...
			>
				<div className="flex-1 md:flex md:justify-center md:items-center">
					<div>
						<p className="text-primary text-3xl font-bold">Indusry</p>
						<p className="text-sx text-gray-400 mb-4">
						...
						>
							<div className="mb-2">
								...
								<BaseInput label="Enter Industry Name" />
							</div>
						...
						>
							<div className="mb-2">
								...
								<BaseInput label="Enter Industry Sub Category" />
							</div>
							{/* <div className="flex gap-2">
								{selectedText.map((text) => (
									<div
