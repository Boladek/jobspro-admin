...
export function Category({ gotoNext, handleForm, form, goBack }) {
  ...
  return (
    ...
    >
      <div className="text-center">
        <p className="text-[12px] font-[700]">Business Category</p>
      ...
      <div>
        {/* <Select
          ...
          isMulti
        /> */}
        <BaseSelect label="Category" />
      </div>
      <div>
        <BaseSelect label="Sub Category" />
      </div>
